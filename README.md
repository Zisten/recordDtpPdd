...
| **Главная** | Карточки статистики, таблицы ДТП и нарушений с поиском/сортировкой |
| **Оформление ДТП** | 7-шаговый wizard: место → ТС → водитель → повреждения → обстоятельства → завершение |
| **Оформление ПДД** | 3-шаговый wizard: нарушитель → ТС (с автоподстановкой) → нарушение |
